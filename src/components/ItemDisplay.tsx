...
export const ItemDisplay = ({title, description, price, type, images}: Props) => {
    return (
        <div className="relative p-3 h-full bg-stone-light">
            <div className="flex flex-col space-y-4 content-between h-full">
                <div className="flex justify-center">
                    <img className="object-cover sm:h-80 sm:w-80" src={images ? "assets/images/uploads/" + images[0] : "assets/images/image-not-found.jpg"} alt="" />
                </div>
