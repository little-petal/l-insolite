...
export default async function Home() {
  ...
  return (
    <main className='bg-sable'>
      <section id="nav-landing-page" className='h-screen bg-cover bg-center bg-no-repeat bg-landing-page-sm md:bg-landing-page-md flex flex-col'>
      ...
      <section id="nav-footer" className="bg-stone-dark relative min-h-screen flex flex-col">
        ...
        <div className="flex flex-1 justify-center items-center flex-col xl:flex-row h-full w-full">
          <div className="font-inter flex xl:basis-1/2 justify-end p-4 sm:p-4 sm:p-2 md:p-8">
            <div className='flex justify-center text-justify md:text-center xl:text-end font-medium flex-col font-georgia text-lg sm:text-xl xl:text-2xl 2xl:text-3xl w-full sm:w-[500px] md:w-full xl:w-[550px] 2xl:w-[650px]'>
