  ...
  return (
    <main className='bg-sable'>
      ...
      <section id="nav-footer" className="bg-stone-dark relative min-h-screen snap-always snap-end flex flex-col">
        <p className="flex justify-center text-4xl sm:text-5xl lg:text-6xl font-cambria p-6">Qui sommes-nous ?</p>
        <div className="flex flex-1 justify-center items-center flex-col xl:flex-row h-full w-full">
          <div className="font-inter flex xl:basis-1/2 justify-end p-2 sm:p-2 md:p-8">
            <div className='flex justify-center text-justify md:text-center xl:text-end font-medium flex-col font-georgia text-xl sm:text-xl xl:text-2xl 2xl:text-3xl w-[400px] sm:w-[500px] md:w-full xl:w-[550px] 2xl:w-[650px]'>
          ...
          <div className="flex xl:basis-1/2 justify-center xl:justify-start w-[400px] sm:w-[500px] md:w-full md:p-2">
